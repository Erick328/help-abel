                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-8">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="datetime" id="nombre" name="nombre" class="form-control" required placeholder="Insertar nombre">
                                            </div>
                                            <div class="input-group">
                                                <span class="input-group-text">
                                                    <i class="fa fa-users"> Precio</i>
                                                </span>
                                                <input type="number" id="precio" name="precio" class="form-control" required min="1" placeholder="1.0">
                                            </div>
                                            <div class="input-group">
                                                <span class="input-group-text">
